...
export default async function echo(data : any, err : Error) {
  await Apify.main(async () => {
    ...
    await requestQueue.addRequest({ url: 'https://etfdb.com/data_set/?tm=87787&cond={%22by_type%22:[%22Etfdb::EtfType%22,1930,null,false,false]}&no_null_sort=true&count_by_id=&limit=25&sort=symbol&order=asc&limit=25&offset=0' });
