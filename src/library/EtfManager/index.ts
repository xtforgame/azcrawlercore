...
export default class EtfManager {
  ...
  update = async (companyMap) => {
    ...
    const tMaps : { [s: string] : {[s: string]: string} } = {
      "category": {
          "Precious Metals": "貴金屬",
          "Global Equities": "全球股市",
          "Asia Pacific Equities": "亞太股票",
          "All Cap Equities": "任何市值股票",
          "Alternative Energy Equities": "替代能源股票",
          "Diversified Portfolio": "多元化投資組合",
          "Large Cap Blend Equities": "大型混合股票",
          "Large Cap Growth Equities": "大型成長股票",
          "Foreign Large Cap Equities": "國外大型股票",
          "Hedge Fund": "對沖基金",
          ...
          "Building & Construction": "建築與工程",
          "Small Cap Blend Equities": "小型混合股票",
          "MLPs": "業主有限合夥",
          "High Yield Bonds": "高收益債券",
          "Latin America Equities": "拉丁美洲股票",
          "Health & Biotech Equities": "健康與生物科技股票",
          "Industrials Equities": "工業股票",
          "Foreign Small & Mid Cap Equities": "國外小型及中型股票",
          "Small Cap Value Equities": "小型價值股票",
          "National Munis": "國家政府債券",
          "Agricultural Commodities": "農產品",
          "Volatility Hedged Equity": "波動性對沖股權",
          "Commodity Producers Equities": "商品製造商股票",
          ...
          "Large Cap Value Equities": "大型價值股票",
          "Currency": "貨幣",
          "Water Equities": "水務股票",
          "Inverse Equities": "反向股票",
          "Global Real Estate": "全球房地產",
